...
#ifndef OL_HLSLANALYZER_HPP
#define OL_HLSLANALYZER_HPP
...
namespace OL
{
    ...
    private:
        ...
        void DecorateASTPrimary(Program& program_a,
        ...
        void AnalyzeCallExprIntrinsicPrimary(CallExpr* call_expr_a,
                                             const HLSLIntrinsicEntry& intr_a);
        ...
        bool AnalyzeStaticTypeSpecifier(const TypeSpecifier* type_specifier_a,
        ...
        void AnalyzeEntryPointParameterInOutVariable(FunctionDecl* func_decl_a,
                                                     VarDecl* var_decl_a,
                                                     bool input_a);

        void AnalyzeEntryPointParameterInOutStruct(FunctionDecl* func_decl_a,
        ...
        void AnalyzeSecondaryEntryPoint(FunctionDecl* func_decl_a,
