...
#ifndef OL_INTRINSICADEPT_HPP
#define OL_INTRINSICADEPT_HPP
...
#define INTRINSIC_IDX(I)                                                       \
    ...
    public:
        ...
        const std::string& GetIntrinsicIdent(const Intrinsic intrinsic_a) const;
        ...
        virtual std::vector<std::size_t> GetIntrinsicOutputParameterIndices(
    ...
    protected:
        ...
        [[noreturn]]
        void ThrowAmbiguousIntrinsicCall(const Intrinsic intrinsic_a,
                                         const std::vector<ExprPtr>& args_a);

    private:
        static const std::size_t num_intrinsics_ =
                (INTRINSIC_IDX(Intrinsic::StreamOutput_RestartStrip) + 1u);
