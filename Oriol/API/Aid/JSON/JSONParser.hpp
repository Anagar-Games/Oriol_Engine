...
#ifndef OL_JSONPARSER_HPP
#define OL_JSONPARSER_HPP
...
namespace OL
{
    ...
    {
    public:
        explicit JSONBool(bool value_a) : value_(value_a)
        {}
    ...
    {
    public:
        explicit JSONNumber(double value_a) : value_(value_a)
        {}
    ...
    {
    public:
        explicit JSONString(const std::string& value_a) : value_(value_a)
        {}
    ...
    public:
        ...
        static std::unique_ptr<JSONValue> ParseFromFile(
    ...
    private:
        ...
        static std::unique_ptr<JSONObject> ParseObject(
        ...
        static std::string ParseString(const std::string& input_a,
                                       size_t& index_a);
        static std::unique_ptr<JSONNumber> ParseNumber(
                const std::string& input_a,
                size_t& index_a);

        static std::unique_ptr<JSONValue> ParseKeyword(
                const std::string& input_a,
                size_t& index_a);
    };
