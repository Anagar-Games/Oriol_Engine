...
#ifndef GLSLCONVERTER_HPP
#define GLSLCONVERTER_HPP
...
namespace OL
{
    ...
    public:
        ...
        static bool ConvertVarDeclBaseTypeDenoter(VarDecl& var_decl_a,
    ...
    private:
        ...
        void RegisterGlobalDeclIdents(const std::vector<VarDecl*>& var_decls_a);
        ...
        void ConvertEntryPointStructPrefixObject(ExprPtr& expr_a,
        ...
        void ConvertEntryPointReturnStmnt(ReturnStmnt& ast_a,
        ...
        void InsertBaseMemberPrefixes(ExprPtr& prefix_expr_a,
                                      const StructDecl* owner_struct_decl_a,
                                      const StructDecl* caller_struct_decl_a);
        ...
        void ConvertSlotRegisters(std::vector<RegisterPtr>& slot_registers_a);
