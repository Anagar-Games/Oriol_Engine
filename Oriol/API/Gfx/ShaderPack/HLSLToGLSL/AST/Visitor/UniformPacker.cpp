...
namespace OL
{
                                ...
                                bool only_reachable_stmnts_a)
    {
        ...
        for (auto it_ = global_stmnts_.begin(); it_ != global_stmnts_.end();)
        {
            ...
            {
                auto var_decl_stmnt_ = std::static_pointer_cast<VarDeclStmnt>(
                        *it_);
                            ...
                            *(var_decl_stmnt_->type_specifier_->type_denoter_)))
                {
                    ...
                    if (IsReachable)
                    {
                        ...
                        decl_stmnt_->decl_object_->flags_ << AST::IsReachable;
                    }
                }
            }
    ...
    {
        decl_stmnt_ = std::make_shared<BasicDeclStmnt>(SourcePosition::ignore);
        {
    ...
    void UniformPacker::AppendUniform(const VarDeclStmntPtr& var_decl_stmnt_a)
    {
