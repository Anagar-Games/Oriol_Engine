...
namespace OL
{
    Variant::Variant(BoolType value_a) : type_ {Types::Bool}, bool_ {value_a}
    {}

    Variant::Variant(IntType value_a) : type_ {Types::Int}, int_ {value_a}
    {}

    Variant::Variant(RealType value_a) : type_ {Types::Real}, real_ {value_a}
    {}
    ...
    Variant::Variant(std::vector<Variant>&& sub_values_a) : type_ {Types::Array}
    {
...
#undef IMPLEMENT_VARIANT_BITWISE_OP
    ...
    {
        auto t_ = Type();
        return (t_ == Types::Bool || t_ == Types::Int || t_ == Types::Real);
    }
