...
namespace OL
{
    ...
    public:
        ...
        std::vector<std::string> ListFiles(const std::string& section_a) const;
    ...
    private:
        ...
        std::unordered_map<std::string, std::vector<FileEntry>> sections_;

        static void WriteString(std::ofstream& out_a, const std::string& s_a)
        {
    ...
    {
    public:
        explicit ResReader(const std::string& res_file_path_a);
