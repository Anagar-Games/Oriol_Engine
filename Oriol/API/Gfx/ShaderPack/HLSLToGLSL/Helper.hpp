...
#ifndef OL_HELPER_HPP
#define OL_HELPER_HPP
...
namespace OL
{
    ...
    void Replace(std::basic_string<CharT, Traits, Allocator>& s_a,
                 ...
                 const char* to_a)
    {
        Replace(s_a, from_a, std::basic_string<CharT, Traits, Allocator>(to_a));
    }
    ...
    void Replace(std::basic_string<CharT, Traits, Allocator>& s_a,
                 ...
                 const std::basic_string<CharT, Traits, Allocator>& to_a)
    {
        Replace(s_a, std::basic_string<CharT, Traits, Allocator>(from_a), to_a);
    }
    ...
    template <>
    inline long long FromStringOrDefault<long long>(const std::string& s_a)
    {
        try
        {
    ...
    template <typename T>
    std::string ToHexString(const T& i_a, const std::string& prefix_a = "0x")
    {
        std::stringstream s_;
