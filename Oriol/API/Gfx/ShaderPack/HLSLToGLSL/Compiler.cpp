...
namespace OL
{
    ...
    bool Compiler::CompileShader(const ShaderInput& input_desc_a,
            ...
            Reflection::ReflectionData* reflection_data_a)
    {
        ...
        if (IsLanguageHLSL(input_desc_a.shader_version_))
            pre_processor_ = MakeUnique<PreProcessor>(*include_handler_, log_);
        ...
        if (IsLanguageHLSL(input_desc_a.shader_version_))
        {
            ...
            program_ = parser_.ParseSource(
                    std::make_shared<SourceCode>(std::move(processed_input_)),
        ...
        if (reflection_data_a)
        {
            ...
            reflectAnalyzer.Reflect(
                    ...
                    *reflection_data_a,
                    ((input_desc_a.warnings_ & Warnings::CodeReflection) != 0));
        }
