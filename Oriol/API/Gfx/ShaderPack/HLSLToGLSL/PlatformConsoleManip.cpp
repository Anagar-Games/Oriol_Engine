...
#ifndef OL_PLATFORMCONSOLEMANIP_HPP
#define OL_PLATFORMCONSOLEMANIP_HPP
...
namespace OL
{
    namespace ConsoleManip
    {
        ...
        void IOModifierState::Pop()
        {
            ...
            {
                auto& stream_ = modifier_stack_.top().stream_;
                ...
                if (modifier_stack_.empty())
                    ...
                    stream_ << modifier_stack_.top().modifier_;
            }
        }
