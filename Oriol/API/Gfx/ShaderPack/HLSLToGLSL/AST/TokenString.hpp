...
namespace OL
{
    ...
    public:
        ...
        public:
            ...
            ConstIterator(const typename Container::const_iterator& it_a,
    ...
    template <typename TokenType, typename TokenOfInterestFunctor>
    bool operator==(
            const BasicTokenString<TokenType, TokenOfInterestFunctor>& lhs_a,
            const BasicTokenString<TokenType, TokenOfInterestFunctor>& rhs_a)
    {
