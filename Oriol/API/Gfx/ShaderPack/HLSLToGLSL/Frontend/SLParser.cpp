...
namespace OL
{
    ...
    SequenceExprPtr SLParser::ParseSequenceExpr(const ExprPtr& first_expr_a)
    {
    ...
    std::string SLParser::ParseIdent(TokenPtr ident_tkn_a, SourceArea* area_a)
    {
        if (!ident_tkn_a)
    ...
    Variant SLParser::ParseAndEvaluateConstExpr()
    {
        ...
        try
        {
            ...
            return expr_evaluator_.Evaluate(*expr_,
