...
#ifndef GLSLEXTENSIONAGENT_HPP
#define GLSLEXTENSIONAGENT_HPP
...
namespace OL
{
    ...
    private:
        ...
        OutputShaderVersion target_glsl_version_ = OutputShaderVersion::GLSL330;
        OutputShaderVersion min_glsl_version_ = OutputShaderVersion::GLSL130;
