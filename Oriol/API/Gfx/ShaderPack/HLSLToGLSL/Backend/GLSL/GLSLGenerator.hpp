...
#ifndef GLSLGENERATOR_HPP
#define GLSLGENERATOR_HPP
...
namespace OL
{
    ...
    private:
        ...
        void GenerateCodePrimary(Program& program_a,
        ...
        const std::string* BufferTypeToKeyword(const BufferType buffer_type_a,
        ...
        bool IsTypeCompatibleWithSemantic(const Semantic semantic_a,
        ...
        int GetBindingLocation(const TypeDenoter* type_denoter_a, bool input_a);
        ...
        void PreProcessStructParameterAnalyzer(const ShaderInput& input_desc_a);
        ...
        void WriteProgramHeaderExtension(const std::string& extension_name_a);
        ...
        void WriteLayout(const std::initializer_list<LayoutEntryFunctor>&
                                 entry_functors_a);

        void WriteLayout(const std::string& value_a);
        void WriteLayoutGlobal(const std::initializer_list<LayoutEntryFunctor>&
                                       entry_functors_a,
        ...
        void WriteLocalInputSemanticsStructDeclParam(VarDeclStmnt* param_a,
        ...
        void WriteGlobalOutputSemanticsSlot(TypeSpecifier* type_specifier_a,
        ...
        void WriteObjectExprIdentOrSystemValue(const ObjectExpr& object_expr_a,
                                               Decl* symbol_a);

        void WriteArrayExpr(const ArrayExpr& array_expr_a);
        void WriteArrayIndices(const std::vector<ExprPtr>& array_indices_a);
        ...
        void WriteTypeModifiers(const std::set<TypeModifier>& type_modifiers_a,
                                const TypeDenoterPtr& type_denoter_a = nullptr);

        void WriteTypeModifiersFrom(const TypeSpecifierPtr& type_specifier_a);
        ...
        void WriteCallExprIntrinsicImageAtomicCompSwap(CallExpr* call_expr_a);

        void WriteCallExprIntrinsicStreamOutputAppend(CallExpr* call_expr_a);
        ...
        void WriteWrapperIntrinsicsMemoryBarrier(const Intrinsic intrinsic_a,
                                                 bool group_sync_a);

        void WriteWrapperIntrinsicsF16toF32();
        void WriteWrapperMatrixSubscript(const MatrixSubscriptUsage& usage_a);
