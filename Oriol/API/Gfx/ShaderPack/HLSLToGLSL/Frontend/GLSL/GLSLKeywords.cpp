...
namespace OL
{
    ...
    {
        return MapKeywordToType(g_data_type_dict_glsl_, keyword_a, R_DataType);
    }
    ...
    static const auto g_storage_class_dict_glsl_ = GenerateStorageClassDict();
    ...
    const std::string* InterpModifierToGLSLKeyword(const InterpModifier t_a)
    {
        return g_inperp_modifier_dict_glsl_.EnumToString(t_a);
    }

    InterpModifier GLSLKeywordToInterpModifier(const std::string& keyword_a)
    {
    ...
    static const auto g_attribute_type_dict_glsl_ = GenerateAttributeTypeDict();
    ...
    {
        return g_attribute_type_dict_glsl_
                .StringToEnumOrDefault(keyword_a, AttributeType::Undefined);
    }
    ...
    const std::string* AttributeValueToGLSLKeyword(const AttributeValue t_a)
    {
        return g_attribute_value_dict_glsl_.EnumToString(t_a);
    }

    AttributeValue GLSLKeywordToAttributeValue(const std::string& keyword_a)
    {
        return g_attribute_value_dict_glsl_
                .StringToEnumOrDefault(keyword_a, AttributeValue::Undefined);
    }
    ...
    static const auto g_primitiv_type_dict_glsl_ = GeneratePrimitiveTypeDict();
    ...
    static std::map<Semantic, GLSLSemanticDescriptor> GenerateSemanticMap()
    {
        ...
        return {{T::ClipDistance, 	      	{"gl_ClipDistance", true}},
                {T::CullDistance, 	   	  	{"gl_CullDistance", true}},
                {T::Coverage,     	   	  	{"gl_SampleMask"}},
                {T::Depth, 		  	   	  	{"gl_FragDepth"}},
                {T::DepthGreaterEqual, 	  	{"gl_FragDepth"}},
                {T::DepthLessEqual,    	  	{"gl_FragDepth"}},
                ...
                {T::StencilRef,				{"gl_FragStencilRef"}},
                {T::Target,				    {"gl_FragData", true}},
                {T::TessFactor,			    {"gl_TessLevelOuter"}},
                {T::VertexID, 				{"gl_VertexID"}},
