...
namespace OL
{
    ...
    {
        return MapKeywordToType(g_data_type_dict_hlsl_, keyword_a, R_DataType);
    }
    ...
    DataType HLSLKeywordExtCgToDataType(const std::string& keyword_a)
    {
        ...
        else
        {
            if (auto type_l1_ = g_data_type_dict_cg_.StringToEnum(keyword_a))
                ...
                RuntimeErr(R_FailedToMapFromCgKeyword(keyword_a, R_DataType));
        }
    }
    ...
    static const auto g_attribute_type_dict_hlsl_ = GenerateAttributeTypeDict();
    ...
    {
        return g_attribute_type_dict_hlsl_
    ...
    static IndexedSemantic HLSLKeywordToSemanticD3D9(const CiString& ident_a)
    {
        using T = Semantic;
        ...
        static const HLSLSemanticMap semantic_map_ {
                ...
                {"SV_Position", {T::VertexPosition}}, // SV_POSITION also
                                                      // allowed in HLSL3
        };
    ...
    static IndexedSemantic HLSLKeywordToSemanticD3D10(const CiString& ident_a)
    {
        using T = Semantic;
