...
#ifndef EXPRCONVERTER_HPP
#define EXPRCONVERTER_HPP
...
namespace OL
{
    ...
    public:
        enum : unsigned int
        {
            ...
            AllPostVisit = (ConvertVectorSubscripts | ConvertMatrixSubscripts
        ...
        static void ConvertExprIfCastRequired(ExprPtr& expr_a,
    ...
    private:
        ...
        void ConvertExprImageAccessArray(ExprPtr& expr_a,
        ...
        void ConvertExprFormatInitializer(ExprPtr& expr_a,
                                          InitializerExpr* init_expr_a,
                                          const TypeDenoter& target_type_den_a);
