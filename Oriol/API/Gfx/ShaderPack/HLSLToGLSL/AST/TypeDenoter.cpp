...
namespace OL
{
    ...
    bool TypeDenoter::Equals(const TypeDenoter& rhs_a, const Flags&) const
    {
    ...
    bool TypeDenoter::AccumAlignedVectorSize(unsigned int&,
                                             unsigned int&,
                                             unsigned int*) const
    {
        return false;
            ...
            const std::vector<ArrayDimensionPtr>& array_dims_a)
    {
        if (array_dims_a.empty())
            ...
            return std::make_shared<ArrayTypeDenoter>(shared_from_this(),
                                                      array_dims_a);
    }
    ...
    {
        auto common_type_ =
                HighestOrderDataType(lhs_type_den_a->data_type_,
    ...
    {
        auto common_type_ =
                HighestOrderDataType(BaseDataType(lhs_type_den_a->data_type_),
                                     BaseDataType(rhs_type_den_a->data_type_));
    ...
    {
        if (auto base_type_den_ = type_den_a.GetAliased().As<BaseTypeDenoter>())
        {
            auto vec_bool_type_ =
                    VectorDataType(DataType::Bool,
    ...
    int TypeDenoter::FindVectorTruncation(const TypeDenoter& source_type_den_a,
                                          ...
                                          int& dest_vec_size_a)
    {
                    ...
                    source_type_den_a.As<BaseTypeDenoter>())
        {
                        ...
                        dest_type_den_a.As<BaseTypeDenoter>())
            {
                ...
                dest_vec_size_a = VectorTypeDim(
                        dest_base_type_den_->data_type_);
    ...
    bool VoidTypeDenoter::IsCastableTo(const TypeDenoter& target_type_a) const
    {
        (void)target_type_a;
        return false;
    }
    ...
    bool NullTypeDenoter::IsCastableTo(const TypeDenoter& target_type_a) const
    {
    ...
    bool BaseTypeDenoter::Equals(const TypeDenoter& rhs_a, const Flags&) const
    {
    ...
    bool BaseTypeDenoter::IsCastableTo(const TypeDenoter& target_type_a) const
    {
    ...
    bool BaseTypeDenoter::AccumAlignedVectorSize(unsigned int& size_a,
                                                 unsigned int& padding_a,
                                                 unsigned int* offset_a) const
    {
        return OL::AccumAlignedVectorSize(data_type_, size_a, padding_a, offset_a);
    }

    TypeDenoterPtr BaseTypeDenoter::GetSubObject(const std::string& ident_a,
                                                 const AST* ast_a)
    {
        try
        {
    ...
    TypeDenoterPtr BufferTypeDenoter::GetSubObject(const std::string& ident_a,
                                                   const AST* ast_a)
    {
        if (ident_a == "mips")
        {
            RuntimeErr(R_NotImplementedYet(ToString() + ".mips", __FUNCTION__),
                       ast_a);
        }
    ...
    {
        if (num_array_indices_a > 0)
            return GetGenericTypeDenoter()->GetSubArray(num_array_indices_a - 1,
                                                        ast_a);
        else
            return shared_from_this();
    }
    ...
    SamplerTypeDenoter::SamplerTypeDenoter(const SamplerType sampler_type__a)
    ...
    {
        return (IsSamplerStateType(sampler_type_) ? "SamplerState" : "Sampler");
    }
    ...
    void StructTypeDenoter::SetIdentIfAnonymous(const std::string& ident_a)
    {
    ...
    bool StructTypeDenoter::IsCastableTo(const TypeDenoter& target_type_a) const
    {
    ...
    bool StructTypeDenoter::AccumAlignedVectorSize(unsigned int& size_a,
                                                   unsigned int& padding_a,
                                                   unsigned int* offset_a) const
    {
        if (struct_decl_ref_)
    ...
    TypeDenoterPtr StructTypeDenoter::GetSubObject(const std::string& ident_a,
                                                   const AST* ast_a)
    {
    ...
    StructDecl* StructTypeDenoter::GetStructDeclOrThrow(const AST* ast_a) const
    {
        if (struct_decl_ref_)
            return struct_decl_ref_;
        else
    ...
    void AliasTypeDenoter::SetIdentIfAnonymous(const std::string& ident_a)
    {
        if (this->ident_.empty())
            this->ident_ = ident_a;
    }
    ...
    bool AliasTypeDenoter::IsCastableTo(const TypeDenoter& target_type_a) const
    {
        return GetAliasedTypeOrThrow()->IsCastableTo(target_type_a);
    }

    bool AliasTypeDenoter::AccumAlignedVectorSize(unsigned int& size_a,
                                                  unsigned int& padding_a,
                                                  unsigned int* offset_a) const
    {
    ...
    TypeDenoterPtr AliasTypeDenoter::GetSubObject(const std::string& ident_a,
                                                  const AST* ast_a)
    {
    ...
    ArrayTypeDenoter::ArrayTypeDenoter(const TypeDenoterPtr& sub_type_denoter_a)
    ...
    bool ArrayTypeDenoter::IsCastableTo(const TypeDenoter& target_type_a) const
    {
    ...
    bool ArrayTypeDenoter::AccumAlignedVectorSize(unsigned int& size_a,
                                                  unsigned int& padding_a,
                                                  unsigned int* offset_a) const
    {
    ...
    bool ArrayTypeDenoter::EqualsDimensions(const ArrayTypeDenoter& rhs_a) const
    {
    ...
    {
        return std::make_shared<FunctionTypeDenoter>(ident_, func_decl_refs_);
    }
