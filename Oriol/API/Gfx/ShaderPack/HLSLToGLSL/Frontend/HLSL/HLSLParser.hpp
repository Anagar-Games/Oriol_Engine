...
#ifndef OL_HLSLPARSER_HPP
#define OL_HLSLPARSER_HPP
...
namespace OL
{
    ...
    private:
        ...
        TypeSpecifierPtr MakeTypeSpecifierIfLhsOfCastExpr(const ExprPtr& expr_);
        ...
        VarDeclPtr ParseVarDecl(VarDeclStmnt* decl_stmnt_ref_a,
        ...
        BufferDeclPtr ParseBufferDecl(BufferDeclStmnt* decl_stmnt_ref_a,
                                      const TokenPtr& ident_tkn_a = nullptr);

        SamplerDeclPtr ParseSamplerDecl(SamplerDeclStmnt* decl_stmnt_ref_a,
                                        const TokenPtr& ident_tkn_a = nullptr);

        StructDeclPtr ParseStructDecl(bool parse_struct_tkn_a = true,
                                      const TokenPtr& ident_tkn_a = nullptr);
        ...
        std::string ParseIdentWithNamespaceOpt(ObjectExprPtr& namespace_expr_a,
                                               TokenPtr ident_tkn_a = nullptr,
                                               SourceArea* area_a = nullptr);

        TypeDenoterPtr ParseTypeDenoter(bool allow_void_type_a = true,
        ...
        AliasTypeDenoterPtr ParseAliasTypeDenoter(std::string ident_a = "");
